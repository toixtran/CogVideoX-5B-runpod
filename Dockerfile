...
# BUILD THỬ BƯỚC 2: bản đầy đủ nhưng BỎ bước làm phẳng (FROM scratch + COPY --from=build / /),
# để xem bước đó có phải thứ làm build trên RunPod Hub fail không log hay không.
